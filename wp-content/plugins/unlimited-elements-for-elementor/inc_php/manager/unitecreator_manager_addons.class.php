...
class UniteCreatorManagerAddonsWork extends UniteCreatorManager{
	...
	public function getAddonAdminHtml($objAddon){
		...
		if($this->isLayouts == true){
			...
			if(!empty($importedTemplateID)){
				...
				$stateLabel = __("Imported","unlimited_elements");
	...
	private function putPreviewTemplateDialog(){
		...
		?>
		<div id="uc_dialog_preview_template" class="uc-dialog-preview-template unite-inputs" title="<?php echo esc_attr($dialogTitle)?>" style="display:none;">
				...
				<div class="uc-dialog-preview-template__right">
					...
					<div class="uc-dialog-preview-template__buttons-panel">
						...
						<a id="uc_dialog_import_template_button_prev" href="javascript:void(0)" class="uc-dialog-preview-template__button-top uc-button-disabled" title="<?php _e("To Previous Template", "unlimited_elements")?>">
							<img src="<?php echo $urlImageBase?>icon-gray-prev.svg">
						</a><a id="uc_dialog_import_template_button_next" href="javascript:void(0)" class="uc-dialog-preview-template__button-top" title="<?php _e("To Next Template", "unlimited_elements")?>">
							<img src="<?php echo $urlImageBase?>icon-gray-next.svg">
						</a><a id="uc_dialog_import_template_button_close" href="javascript:void(0)" class="uc-dialog-preview-template__button-top" title="<?php _e("Back To Catalog", "unlimited_elements")?>">
					...
					<div class="uc-dialog-preview-template__right-operations">
						...
						<h2><?php _e("Import Template","unlimited_elements")?></h2>
						
						<p>
							<?php _e("To get started click the \"Import Template\" button.","unlimited_elements")?>
							<?php _e("After import is completed the template will show under Elementor Saved Templates list for future use.","unlimited_elements")?>
						</p>
						
						<br>
						
						<a href="javascript:void(0)" class="unite-button-primary uc-dialog-preview-template__button-import uc-show-when-new"><?php _e("Import Template","unlimited_elements")?></a>
						<a href="javascript:void(0)" class="unite-button-primary uc-dialog-preview-template__button-import-again uc-show-when-imported" data-message-confirm="<?php echo $confirmImportAgainMessage?>" ><?php _e("Import Template Again","unlimited_elements")?></a>
						...
						<div id="uc_dialog_import_template_imported_message" class="uc-dialog-preview-template__imported-message" style="display:none">
							...
							<div class="uc-dialog-preview-template__imported-message-text">
								<span class="uc-show-when-new"><?php _e("Template Imported Successfully","unlimited_elements")?>.</span>
								<span class="uc-show-when-imported"><?php _e("Template Already Imported","unlimited_elements")?>.</span>
							</div>
							
							<div class="uc-dialog-preview-template__action-buttons-wrapper">
								<a href="#" class="unite-button-secondary uc-dialog-preview-template__imported-message-link1" target="_blank" data-text-bottom="<?php _e("View Page", "unlimited_elements")?>" data-text-top="<?php _e("View Template", "unlimited_elements")?>"><?php _e("View Template", "unlimited_elements")?></a>
								<a href="#" class="unite-button-secondary uc-dialog-preview-template__imported-message-link2" target="_blank"><?php _e("Edit With Elementor","unlimited_elements")?></a>
							</div>
						</div>
						
						<div class="uc-dialog-preview-template__create-page-wrapper">
							
							<h2><?php _e("Create Page From Template","unlimited_elements")?></h2>
							
							<div class="uc-dialog-preview-template__import-page-wrapper">
							
								<input type="text" placeholder="<?php _e("Enter Page Name", "unlimited_elements")?>" class="uc-dialog-preview-template__page-name">
								<a href="javascript:void(0)" class="unite-button-secondary uc-dialog-preview-template__button-create-page"><?php _e("Create Page","unlimited_elements")?></a>
					...
					<div class="uc-dialog-preview-template__right-message-pro">
						...
						<?php _e("This template is available only for the PRO version users of Unlimited Elements plugin.","unlimited_elements")?>
						
						<br><br>
						
						<?php _e("You can purchase a pro version here","unlimited_elements")?>: 
